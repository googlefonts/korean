  ...
  render() {
    ...
    return (
      <div className="description__container">
        ...
        <h4 style={fontNames.title}>
          Google Fonts에서는 머신 러닝에 기반을 둔 최적화 기술을 통해 한글 폰트를 동적으로 분할 다운로드합니다.
        </h4>


        <p style={fontNames.paragraph}>
          웹상의 방대한 한국어 문서를 분석한 결과, Google은 주제에 따라 사용되는 글자의 패턴을 발견하고, 패턴에 따라 한글 폰트에 포함된 10,000여 가지 글리프를 000가지 그룹으로 나누었습니다. 그리고 Google Fonts에서는 사용자가 웹 페이지를 불러올 때, 폰트 전체를 다운로드 하는 대신 내용을 표시하는 데 꼭 필요한 몇 가지 그룹만을 선택적으로 다운로드 하는 방식으로 폰트를 제공합니다. 이 기술을 적용한 Google Font를 사용하면 폰트 전체를 다운로드한 것과 다름없는 페이지를 보다 빠르게 제공할 수 있습니다. 
        </p>
        ...
        <h4 style={fontNames.title}>
          Google Fonts + 한국어는 공공을 위한 가치를 지향합니다.
        </h4>


        <p style={fontNames.paragraph}>
          Google Fonts + 한국어에 실린 모든 폰트는 오픈 폰트 라이선스(OFL)를 따르므로, 누구나 마음에 드는 폰트를 자유롭게 사용하고, 친구나 직장 동료와 공유할 수 있습니다. 소수 문자의 발전을 추구하는 비영리 기관인 ‘국제 SIL’에서 제안한 오픈 폰트 라이선스의 대상은 폰트 및 폰트 디자인, 언어를 활용하는 소프트웨어의 개발 및 엔지니어링 등을 망라합니다. 오픈 폰트 라이선스는 세계 어느 곳에서나 폰트 관련 기술을 협력적으로 개발 및 공유하고, 개선할 수 있는 법적 기반을 제공합니다. 
        </p>
